...
def write_log(callback, name, loss, batch_no):
    ...
    summary_writer = tf.summary.create_file_writer(callback.log_dir)
    
    with summary_writer.as_default():  # Use the default writer from the callback
        tf.summary.scalar(name, loss, step=batch_no)
    
    # Flush the writer to write the summary to the log file
